namespace Quoteversation.Web.Areas.Administration.Controllers
{
    ...
    {
        public KendoGridAdministrationController(IQuoteversationData data)
            : base(data)
        {
        }
        ...
        protected abstract T GetById<T>(int id) where T : class;
        ...
        [NonAction]
        protected virtual void Update<TModel, TViewModel>(TViewModel model, int id)
            where TModel : class
